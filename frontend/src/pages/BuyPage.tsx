...
export default function BuyPage() {
  ...
  const categories = categoriesData?.categories ?? (categoriesError ? mockCategories : [])
  const apiProducts = productsData?.products ?? (productsError ? mockProducts : [])
  ...
  const products = useMemo(() => {
    ...
    if (selectedCategory !== null) {
      ...
      const categoryIds = getAllCategoryIds(mockCategories, selectedCategory)
